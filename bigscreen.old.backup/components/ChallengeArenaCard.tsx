        ...
        <div className="h-full overflow-hidden relative">
          <div className="absolute top-0 left-0 w-full h-max animate-scroll-vertical">
            {displayChallenges.map((challenge, index) => {
              // Handle both old format (challenge.challenger) and new API format (challenger_name, challenger_avatar)
          ...
          <style>{`
            ...
            .animate-scroll-vertical {
              ...
              animation: scroll-vertical ${Math.max(30, allChallenges.length * 5)}s linear infinite;
            }
          `}</style>
        </div>
      )}
